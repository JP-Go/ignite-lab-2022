  ...
  return (
    <div>
      <div className='bg-gray-700 mt-0 w-full text-right pt-2'>
        ...
        <a
          href={'https://gitlab.com/JP-Go/event-platform'}
					target="_blank"
        ...
        >
          <div className='bg-gray-700 inline-flex items-center px-1 rounded border border-gray-300 group hover:bg-gray-500'>
            <span className='font-bold text-white pr-1'>{'GitLab'}</span>
            <GitlabLogo size={20} className='inline text-orange-300 group-hover:text-orange-500' />
          </div>
        </a>
      </div>
